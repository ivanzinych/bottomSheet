...
public struct SheetOptions {
    ...
    public var hasOverlay = true
    
    public var presentingViewCornerRadius: CGFloat = 22
    ...
    public var autoAdjustToKeyboard = true
    ...
    public var minimumSpaceAbovePullBar: CGFloat = 50
    ...
    public init(pullBarHeight: CGFloat? = nil,
        ...
        self.pullDownEnabled = pullDownEnabled
    }
